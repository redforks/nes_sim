...
[parallel]
passed_cpu_tests: cpu-test instr_misc instr_test-v5 instr_test-v3 instr_timing cpu_dummy_reads cpu_dummy_writes cpu_exec_space cpu_reset nestest branch_timing_tests nes_instr_test cpu_timing_test6

[parallel]
passed_ppu_tests: oam_read oam_stress ppu_open_bus ppu_read_buffer sprite_hit_tests sprite_overflow_tests scanline sprdma_and_dmc_dma

[parallel]
passed_apu_tests: apu_mixer apu_reset apu_test dmc_dma_during_read4

todo_tests: mmc3_test_4 mmc3_test_6 mmc3_test2_4 vbl_nmi_timing ppu_vbl_nmi cpu_interrupts_v2

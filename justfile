...
[parallel]
passed_ppu_tests: oam_read oam_stress ppu_open_bus ppu_read_buffer sprite_hit_tests sprite_overflow_tests scanline sprdma_and_dmc_dma vbl_nmi_timing

[parallel]
passed_apu_tests: apu_mixer apu_reset apu_test dmc_dma_during_read4

todo_tests: mmc3_test_4 mmc3_test_6 mmc3_test2_4 ppu_vbl_nmi cpu_interrupts_v2

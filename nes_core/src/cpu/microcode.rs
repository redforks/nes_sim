...
const fn build_opcode_table() -> [ArrayVec<[Microcode; 7]>; 256] {
    ...
    r[LDX_ABSOLUTE_INDEXED_Y as usize] = microcode_arr!(
        ...
        AbsoluteIndexedYWithOp {
            op: AbsoluteIndexedYOp::LoadIntoX,
            first_clock: CrossPageBehavior::FirstClock
        }
    );

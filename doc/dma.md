...
<div class="mw-collapsible mw-collapsed" style="border:1px solid #a2a9b1; padding: 5px; display: inline-block; min-width: 25em; overflow:auto;">
...
OAM DMA has a lower priority than DMC DMA. If a DMC DMA get occurs during OAM DMA, OAM DMA is briefly paused. (See [[#DMC DMA during OAM DMA|DMC DMA during OAM DMA]])
...
* DMC DMA on last OAM DMA put, taking 3 cycles
              ...
